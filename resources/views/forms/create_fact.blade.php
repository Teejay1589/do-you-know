	...
	<div class="row">
		...
		<div class="form-group col-md-3 {{ $errors->has('fact_image') ? ' has-error' : '' }}"> 
	        <div id="preview">
	            ...
	            @else
	            <img class="thumbnail img-responsive center-block change_fact_image" src="{{ asset('') }}" alt="Fact Image" style="min-height: 120px;">
	            @endif
	        </div>
	...
	<div class="row">
			...
			<select id="tags" name="tags[]" class="form-control" multiple>
				@if ( old('tags') != null )
	          	...
	          	@foreach ($tags as $element)
	      			@if ( old('tags') != null )
	      				@if ( in_array($element->tag, old('tags'))  )
	              		@else
		...
		@if (Auth::user()->role_id == 3)
			<div class="form-group col-md-3">
	            ...
	            <div class="checkbox">
	                <label>
	                	<input type="checkbox" name="is_approved" {{ old('is_approved') ? 'checked' : '' }}> Is Approved
	                </label>
