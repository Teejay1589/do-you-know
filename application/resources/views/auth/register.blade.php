                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('telephone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="telephone" class="form-control" name="telephone" value="{{ old('telephone') }}" >
                        ...
                        <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                            <label for="gender" class="col-md-4 control-label">Gender: <span class="text-danger">*</span></label>
